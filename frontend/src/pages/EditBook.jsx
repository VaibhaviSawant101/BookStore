...
const EditBook = () => {
  ...
  const handleEditBook = () =>{
    ...
    .then(()=>{
      setLoading(false);
      enqueueSnackbar('Book Edied Successfully', { variant: 'success' });
      navigate('/');
    })
    .catch((err)=>{
      setLoading(false);
    ...
    <div className='p-4'>
      ...
      <div className='flex flex-col border-2 border-sky-400 rounded-xl w-[600px] p-4 mx-auto'>
        ...
        <div className='my-4'>
          ...
          <input 
          type="text" value={publishYear} onChange={(e)=>{setPublishYear(e.target.value)}} className='border-2 border-gray-500 px-4 py-2 w-full' />
        </div>
